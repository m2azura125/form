...
new class extends Component
{
    ...
    public function updateProfileInformation(): void
    {
        ...
        $validated = $this->validate([
            ...
            'username' => ['required', 'string', 'min:3', 'max:50', 'regex:/^[a-zA-Z0-9._-]+$/', Rule::unique(User::class)->ignore($user->id)],
...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <p class="mt-1.5 text-xs text-zinc-400">Dipakai untuk login, sebagai alternatif dari email.</p>
        </div>
